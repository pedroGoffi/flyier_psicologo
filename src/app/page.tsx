...
const ServiceItem: React.FC<ServiceItemProps> = ({ service, primaryColor, secondaryColor, darkMode, lightBg }) => {
  return (
    <div 
      className="group relative p-6 rounded-2xl border-2 transition-all hover:scale-105 hover:shadow-2xl overflow-hidden"
      style={{ 
        borderColor: primaryColor + "30",
        backgroundColor: darkMode ? "#1A1515" : lightBg,
    ...
    >
      ...
      {service.recommended && (
        <div 
          className="absolute top-4 right-4 px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg"
          style={{ 
      ...
      <div className="relative z-10 flex gap-4 items-start">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-lg leading-tight mb-2" style={{ color: primaryColor }}>
            {service.name}
          </h3>
          <p className="text-sm text-gray-600 mb-4 leading-relaxed">{service.description}</p>
          <div className="flex items-center justify-between flex-wrap gap-3 pt-3 border-t" style={{ borderColor: primaryColor + "20" }}>
            <p className="text-base font-bold" style={{ color: primaryColor }}>
              {service.price}
            </p>
            <div className="flex items-center gap-2 text-sm font-semibold" style={{ color: secondaryColor }}>
